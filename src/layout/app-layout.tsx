...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'auditor', 'manager', 'staff-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Audits', path: '/audits', entity: 'audit', service: AccessServiceEnum.PROJECT, icon: FiSearch },
    {
      name: 'Audit Items',
      path: '/audit-items',
      entity: 'audit_item',
    ...
    { name: 'Managers', path: '/managers', entity: 'manager', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    {
